...
<li><a href="Doctor_insert.jsp">Doctor</a></li>
      ...
      <td width="811" align="center" valign="top"><table width="80%" border="0" align="center" cellpadding="5" cellspacing="5">
          <tr>
            <td height="128" align="center"><p class="style101">Contact Us</p>
              <p><strong>Blood-Bank Management</strong></p>
              <p><strong>T:</strong> &nbsp; +91-8130077231<br />
            <strong>Email : </strong><a href="#">Blood@gmail.com</a>,&nbsp; <a href="mailto:eyeinvest@eyemgt.com">raviitsoft@gmail.com</a></p></td>
          </tr>
          <tr>
            <td width="474" height="128"><img src="img/contct.jpg" width="900" height="479" /></td>
          </tr>
        </table>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
