  ...
  <table width="90%" border="0" align="center" cellpadding="5" cellspacing="5">
    ...
    <tr>
      <td width="138" valign="top" bgcolor="#EEEEEE"><ul id="MenuBar1" class="MenuBarVertical">
        ...
        <li><a href="SearchBloodStock_user.jsp">Search Blood Stock</a></li>
<li><a href="donar.jsp">Blood Donar</a></li>
<li><a href="Receiver.jsp">Blood Receiver</a></li>
<li><a href="BloodBank.jsp">Hospital Of India</a></li>
<li><a href="campas_list.jsp">Blood Donations Camp</a></li>
<li><a href="feedback.jsp">Feed Back</a></li>
<li><a href="logout.jsp">Logout</a></li>
      </ul></td>
      <td width="900" align="center"><img src="FirstImage/1.png" width="900" height="400" border="0" id="id1" onclick="first()" /></td>
    </tr>
    <tr>
