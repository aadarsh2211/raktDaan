    ...
    <tr>
      <td colspan="2" valign="top"><table  width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="825" height="87" align="center" valign="top" bgcolor="#1D3752"><br />            <img src="img/Header.jpg" width="584" height="100" border="11" /></td>
        </tr>
      </table></td>
    </tr>
    <tr>
      <td width="149" align="center" valign="top"><a href="welcome.jsp"><img src="img/hm.png" width="45" height="45" /></a>
      <p><img src="img/images (1).jpg" width="200" height="222" /></p></td>
      <td width="811" align="center"><br />
        <table rules="none" width="100%" height="748" border="1" align="center" cellpadding="3" cellspacing="3">
        <tr>
          <td colspan="2" align="center" bgcolor="#1D3752"><h3><img width="470" height="106" src="donar_clip_image001.png" alt="Horizontal Scroll: BLOOD DONOR FORM" /></h3></td>
          </tr>
        <tr>
          <td width="239">Donar Id</td>
...
%>
            ...
            <a href="SearchViewHospital_record.jsp">View Hospital</a></td>
        </tr>
        <tr>
          <td>Hospital Name</td>
        ...
        <tr>
          <td height="25"><p>How Much Unit Blood Can You Donate(In Unit)</p></td>
